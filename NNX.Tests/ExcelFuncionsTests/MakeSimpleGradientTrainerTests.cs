...
namespace NNX.Tests.ExcelFuncionsTests
{
    public class MakeSimpleGradientTrainerTests : ObjectStoreTests
    {
        ...
        {
            ExcelFunctions.MakeSimpleGradientTrainer("t", 10, 0.1, 0, 0, 2, 0, 0);
        ...
        {
            var expected = "t";
            var result = ExcelFunctions.MakeSimpleGradientTrainer(expected, 10, 0.1, 0, 0, 2, 0, 0);
        ...
        {
            ExcelFunctions.MakeSimpleGradientTrainer("t", 10, 0.1, 0.2, 0, 2, 0, 0);
            var result = ObjectStore.Get<SimpleGradientTrainer>("t");
        ...
        {
            ExcelFunctions.MakeSimpleGradientTrainer("t", 10, 0.1, 0, 0.3, 2, 0, 0);
            var result = ObjectStore.Get<SimpleGradientTrainer>("t");
        ...
        {
            ExcelFunctions.MakeSimpleGradientTrainer("t", 10, 0.1, 0, 0.3, 2, 0, 20);
            var result = ObjectStore.Get<SimpleGradientTrainer>("t");
        ...
        [Fact]
        public void ShouldStoreMaxRelativeNouse()
        {
            ExcelFunctions.MakeSimpleGradientTrainer("t", 10, 0.1, 0, 0.3, 2, 0.5, 20);
            var result = ObjectStore.Get<SimpleGradientTrainer>("t");
            Assert.Equal(0.5, result.MaxRelativeNoise);
        }
        ...
        {
            Action action = () => ExcelFunctions.MakeSimpleGradientTrainer("t", badNumEpochs, 0.1, 0, 0, 2, 0, 0);
        ...
        {
            Action action = () => ExcelFunctions.MakeSimpleGradientTrainer("t", 10, badLearningRate, 0, 0, 2, 0, 0);
            action.ShouldThrow<NeuralNetworkException>();
        }
        ...
        {
            Action action = () => ExcelFunctions.MakeSimpleGradientTrainer("t", 10, 0.1, -2, 0, 2, 0, 0);
            action.ShouldThrow<NeuralNetworkException>();
        }
        ...
        {
            Action action = () => ExcelFunctions.MakeSimpleGradientTrainer("t", 10, 0.1, 0, -2, 2, 0, 0);
            action.ShouldThrow<NeuralNetworkException>();
        }
    }
}
